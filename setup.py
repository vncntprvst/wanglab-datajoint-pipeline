...
long_description = """"
Pipeline for the Wang Lab at the McGovern Institute for Brain Research at MIT.
...
setup(
    ...
    license='MIT',
    url='https://github.com/vncntprvst/wanglab-datajoint-pipeline',
